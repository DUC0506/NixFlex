    ...
    return(
        <Watch>
            ...
            <div className="videoContainer">
                <div className="videoDes">
                    <div className="videoInfo">
                        <h4>Điệp Viên Không Không Thấy Tái Xuất</h4>
                        <h3>Johnny English Reborn</h3>
                        <div className="videoTime">
                            
                            <div className="videoTime_Year">2011</div>
                            <div className="videoTime_Age">13+</div>
                            <div className="videoTime_During">1 giờ 41 phút</div>
                            <div className="videoTime_Country">Anh</div>

                        </div>
                        <p>Sau nhiều năm ẩn cư để quên đi một nhiệm vụ thất bại, cuối cùng Johnny English cũng được MI7 mời về làm việc trở lại. Lần này anh được giao sứ mệnh điều tra âm mưu ám sát một nguyên thủ quốc gia quan trọng. Liệu English sẽ làm tròn công việc được giao, hay lại một lần nữa thảm bại ê chề?</p>
                    </div>
            ...
            <div className="videoRelated">
                ...
                <MoviesRow movies={movie} title="Related Movies" idSection='trending'/>
                </div>
